...
const StdHome = (props) => {
    ...
    useEffect(() => {
        ...
        Firebase.database().ref('Company/').on("value",(datasnap)=>{
    ...
    return (
        <View style={styles.container}>
                <TouchableOpacity style={styles.btn} onPress={()=> props.navigation.navigate('Job Vacancy')}>
                    <Text style={styles.paragraph}>Find Job</Text>
                </TouchableOpacity>
            ...
            {isDonor ? (
             ...
             : ( <Text style={styles.text}>No Company's Available Right Now</Text>)
            }
        </View>
    )
}
